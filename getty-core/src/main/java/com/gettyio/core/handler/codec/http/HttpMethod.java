...
import com.gettyio.core.util.MathUtil;

import static com.gettyio.core.util.ObjectUtil.checkNotNull;


/**
 * HttpMethod.java
 *
 * @description:The request method of HTTP or its derived protocols
 * @author:gogym
 * @date:2020/4/9
...
public class HttpMethod implements Comparable<HttpMethod> {
    ...
    private static final class EnumNameMap<T> {
        ...
        EnumNameMap(Node<T>... nodes) {
            values = (Node<T>[]) new Node[MathUtil.findNextPositivePowerOfTwo(nodes.length)];
